...
import static holt.DFDToJavaFileConverter.getGeneratedAnnotation;
import static holt.DFDToJavaFileConverter.toClassName;
...
public final class TraversesGenerator {
    ...
    public static JavaFile generateExternalEntityJavaFile(Domain domain, String dfdPackageName, ExternalEntityActivatorAggregate externalEntityActivator) {
